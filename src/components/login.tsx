...
const Login: React.FC = () => {
  const discordAuthURL =
    "https://discord.com/api/oauth2/authorize?client_id=1069266927513505862&redirect_uri=https%3A%2F%2Fvalearnis-quiz.vercel.app%2F&response_type=code&scope=identify%20email";
